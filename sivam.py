...
class UDPSender:
    ...
    def __init__(self, host=host_windows, port=5005): 
        ...
        with open('endereco_ip.txt', 'r') as f:
...
home_dir = '' # ARQUIVO LOCAL PARA TESTES, MUDAR PARA O DIRETÓRIO DESEJADO PARA SALVAR OS ARQUIVOS DE CALIBRAÇÃO E GRAVAÇÃO DOS DADOS
